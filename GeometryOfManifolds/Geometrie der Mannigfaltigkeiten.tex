...
\Def{}
Eine nichttriviale, diskrete Untergruppe $\Gamma \subset Isom(\H^n)$ heißt \df{elementar}, wenn es eine endliche Menge $\emptyset \neq S \subset \overline{\H^n}$ gibt, die von $\Gamma$ fixiert wird, d.\,h.,
\[ Fix(\phi) = S \forall \phi \in \Gamma  \]
...
\begin{Beweis}{}
$\Gamma$ agiert frei und enthält deswegen kein elliptischen Elemente. $S$ muss ergo in $\partial \H^n$ liegen und aus einem, oder zwei Elementen bestehen. Der Rest folgt nun aus Lemma \ref{Lemma 422}.
\end{Beweis}
