...
\begin{itemize}
	...
	\begin{enumerate}[1.)]
		...
		\item Satz von Whitehead: Ein endlicher Zellkomplex $X$ ist genau dann asphärisch, d.\,h., seine universelle Überlagerung ist null-homotop , wenn $\pi_i(X) = 0$ für alle $i\geq 2$.
	...
	\end{enumerate}
Wir wissen also, dass ein Isomorphismus von Fundamentalgruppen durch eine Homotopie-Äquivalenz $f : M \pfeil{} N$ induziert wird.
