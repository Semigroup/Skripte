...
\subsection{3.10 Satz von Sabidussi}
$f : G \rightarrow Aut(\Gamma)$ Ghom., $\Gamma$ kombinatorischer Graph
\begin{enumerate}
	\item $f$ äquivalent zur Linkstranslation von $G$ auf $Cay(G,S)$ für red. EZS $S$\\
