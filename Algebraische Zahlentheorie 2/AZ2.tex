...
Es bezeichne $\delta = \delta_{L|K}$ die \df{Diskriminante} von $L|K$, d.\,h., dasjenige Ideal, das von allen Determinanten aller in $\O_L$ liegenden Basen des $K$-Vektorraums $L$ erzeugt wird. Es gilt
