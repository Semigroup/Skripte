...
\Def{}
Eine Isometrie $f$ von $M$ heißt \df{Transvektion}, falls ein Punkt $p \in M$ und ein Weg $c : p \mapsto f(p)$ existieren, sodass $\d f_p : T_pM \pfeil{} T_{f(p)}M$ der Paralleltransport entlang $c$ ist.
